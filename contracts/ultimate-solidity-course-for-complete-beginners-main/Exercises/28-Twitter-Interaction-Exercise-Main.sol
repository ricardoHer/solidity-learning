...
contract Twitter is Ownable {
    ...
    modifier onlyRegistered() {
        IProfile.UserProfile memory userProfileData = profileContract.getProfile(msg.sender);
        require(bytes(userProfileData.displayName).length > 0 , "You're not registered");
        _;
    }
